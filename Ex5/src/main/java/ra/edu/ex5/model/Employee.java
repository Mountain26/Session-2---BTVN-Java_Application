...
public class Employee {
    ...
    public Employee(String code, String name, String department, double salary, Date joinDate, String status) {
        this.code = code; this.name = name; this.department = department;
        this.salary = salary; this.joinDate = joinDate; this.status = status;
    }
    ...
    public Date getJoinDate() { return joinDate; } public String getStatus() { return status; }
}